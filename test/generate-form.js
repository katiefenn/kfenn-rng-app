casper.test.begin('Roman numeral generator form', 3, function suite(test) {
    ...
    casper.waitForSelector('#decimal-to-roman-form', function() {
        ...
        test.assertExists('#decimal-to-roman-form .form__input', "form field is found");
    });

    casper.waitForSelector('#decimal-to-roman-form .form__input', function () {
        casper.sendKeys('#decimal-to-roman-form .form__input', '10');
    });

    casper.then(function () {
        test.assertSelectorHasText(
            '#decimal-to-roman-form .form__result',
            'X',
